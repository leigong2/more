...
public class AppUtils {
    ...
    public static boolean isFirstRun(SharedPreferences sharedPreferences) {
        ...
        boolean returnValue = isFirstRun;
    ...
    public static int getXPercentOfY(int X, int Y) {
        return (X * Y) / 100;
    }

    public static float getXPercentOfY(float X, float Y) {
        return (X * Y) / 100;
    }

    public static long getXPercentOfY(long X, long Y) {
        return (X * Y) / 100;
    }

    public static double getXPercentOfY(double X, double Y) {
        return (X * Y) / 100;
    }

    public static String getThisFromAssets(Context context, String fileName) {
        String respone = null;
        try {
            ...
            is.read(buffer);
            is.close();
            respone = new String(buffer, "UTF-8");
    ...
    public static void switchfragment(AppCompatActivity activity, View container, Fragment fragment) {
    ...
    public static void switchfragment(AppCompatActivity activity, View container, Fragment fragment,
                                      String toolbarTitle) throws Resources.NotFoundException {
    ...
    public static boolean isAppVersionUpdated(Context context, SharedPreferences sharedPreferences) {
        PackageInfo pInfo = null;
        try {
            pInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), 0);
        } catch (PackageManager.NameNotFoundException e) {
    ...
    public static float dp2px(Context context, float dp) {
        ...
        DisplayMetrics displaymetrics = new DisplayMetrics();
        display.getMetrics(displaymetrics);
        return (float) (dp * displaymetrics.density + 0.5f);
    }
    ...
    public static float px2dp(Context context, float px) {
        ...
        DisplayMetrics displaymetrics = new DisplayMetrics();
        display.getMetrics(displaymetrics);
        return (float) (px / displaymetrics.density + 0.5f);
    }
