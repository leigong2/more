...
public class XRecyclerView extends RecyclerView {
    ...
    private boolean isChannelView = false;
    ...
    public boolean isChannelView() {
        return isChannelView;
    }

    public void setChannelView(boolean channelView) {
...
//                        && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 && layoutManager.getItemCount()+1 >= layoutManager.getChildCount() && !isNoMore && mRefreshHeader.getState() <= ArrowRefreshHeader.STATE_REFRESHING) {
//                    isLoadingData = true;
//                    if (mFootView instanceof LoadingMoreFooter) {
