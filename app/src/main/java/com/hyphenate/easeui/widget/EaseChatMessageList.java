...
public class EaseChatMessageList extends RelativeLayout{
     ...
     */
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider,String nickName,String headerUrl) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, chatType, listView,nickName,headerUrl);
    ...
    public interface MessageListItemClickListener{
	    ...
	    void onUserAvatarLongClick(EMMessage message);
	}
