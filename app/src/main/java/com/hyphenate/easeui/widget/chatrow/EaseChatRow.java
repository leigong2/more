...
public abstract class EaseChatRow extends LinearLayout {
    ...
    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter,int type) {
        super(context);
        this.context = context;
        this.activity = (Activity) context;
        this.message = message;
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar(context, MoreUser.getInstance().getThumb(), userAvatarView);
            EaseUserUtils.setUserNick(MoreUser.getInstance().getNickname(), usernickView);
        }else{
            try {
                EaseUserUtils.setUserAvatar(context, message.getStringAttribute("headerUrl"), userAvatarView);
                EaseUserUtils.setUserNick(message.getStringAttribute("nickName"), usernickView);
            }catch ( Exception e){
                EaseUserUtils.setUserAvatar(context, "", userAvatarView);
