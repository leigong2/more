...
public class TabFragmentHost extends TabHost implements
    ...
    public void onTabChanged(String tabId) {
        HomeStarFragment fragment0 = (HomeStarFragment) mFragmentManager.findFragmentByTag("tab0");
        if (("tab3".equals(tabId) || "tab4".equals(tabId)) && MoreUser.getInstance().getUid().equals(0L)) {
            ActivityOptionsCompat compat = ActivityOptionsCompat.makeCustomAnimation(
                    mContext, R.anim.slide_right_in, R.anim.slide_right_out);
            Intent intent = new Intent(mContext, UseLoginActivity.class);
        ...
        } else if (!"tab0".equals(tabId) && fragment0 != null && fragment0.wave_layout.getVisibility() == View.VISIBLE
                && fragment0.ivErrer.getVisibility() == View.GONE) {
            setCurrentTab(0);
            return;
        } else {
            if (mAttached) {
