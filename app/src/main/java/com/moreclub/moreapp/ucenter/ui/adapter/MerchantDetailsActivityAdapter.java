...
public class MerchantDetailsActivityAdapter extends RecyclerAdapter<MerchantActivity> {

    private static final AccelerateInterpolator ACCELERATE_INTERPOLATOR = new AccelerateInterpolator();
    private static final OvershootInterpolator OVERSHOOT_INTERPOLATOR = new OvershootInterpolator(4);

    public MerchantDetailsActivityAdapter(Context context, int layoutId, ArrayList<MerchantActivity> datas) {
    ...
    public void convert(final RecyclerViewHolder holder, final MerchantActivity activityItem) {
        ...
        holder.setText(R.id.tv_activities_location, activityItem.getIntroduction());
