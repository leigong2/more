...
public class FoodLikeActivity extends BaseActivity implements IJobTagLoader.JobTagDataBinder {
    ...
    private void setupView() {
        activityTitle.setText("菜肴喜好");
        tagTitle.setText("菜肴喜好");
        String modal = MODAL_ARRAY[7];
        userChoiceTags = new ArrayList<>();
        String wineLikes = getIntent().getStringExtra("foodLike");
        if (!TextUtils.isEmpty(wineLikes)) {
            String[] jobArr = wineLikes.split(" ");
    ...
    public void onTagResponse(RespDto<Map<String, List<UserTag>>> res) {
        ...
        List<UserTag> userTags = data.get(MODAL_ARRAY[7]);
    ...
    private TagAdapter setTagAdapter(final TagFlowLayout jobsLay, final List<UserTag> userTags, final boolean isChoice) {
        TagAdapter adapter = new TagAdapter<UserTag>(userTags) {
            ...
            public View getView(FlowLayout parent, int position, UserTag userTag) {
                ...
                if (isChoice) {
                    int padding = ScreenUtil.dp2px(FoodLikeActivity.this, 9);
                    tv.setPadding(padding,ScreenUtil.dp2px(FoodLikeActivity.this, 6),padding,padding);
                    ...
                    int height = 12 + ScreenUtil.dp2px(FoodLikeActivity.this, 12);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.saveButton:
                ...
                intent.putExtra("foodLike", jobTags.toString());
                FoodLikeActivity.this.setResult(11, intent);
                FoodLikeActivity.this.finish();
                overridePendingTransition(R.anim.fade_in, R.anim.slide_right_out);
                break;
        }
    }
    ...
    private class StickerSpan extends ImageSpan {
        ...
        public void draw(Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
            ...
            canvas.save();
            int transY = (int) (bottom - b.getBounds().bottom - ScreenUtil.dp2px(FoodLikeActivity.this, 0));// 减去行间距
