...
public class BrandActivity extends BaseActivity implements IJobTagLoader.JobTagDataBinder {
    ...
    private void setupView() {
        activityTitle.setText("品牌喜好");
        tagTitle.setText("品牌喜好");
        String modal = MODAL_ARRAY[4];
        userChoiceTags = new ArrayList<>();
        String wineLikes = getIntent().getStringExtra("brand");
    ...
    public void onTagResponse(RespDto<Map<String, List<UserTag>>> res) {
        ...
        List<UserTag> userTags = data.get(MODAL_ARRAY[4]);
    ...
    private TagAdapter setTagAdapter(final TagFlowLayout jobsLay, final List<UserTag> userTags, final boolean isChoice) {
        TagAdapter adapter = new TagAdapter<UserTag>(userTags) {
            ...
            public View getView(FlowLayout parent, int position, UserTag userTag) {
                ...
                if (isChoice) {
                    int padding = ScreenUtil.dp2px(BrandActivity.this, 9);
                    tv.setPadding(padding,ScreenUtil.dp2px(BrandActivity.this, 6),padding,padding);
                    ...
                    int height = 12 + ScreenUtil.dp2px(BrandActivity.this, 12);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.saveButton:
                ...
                intent.putExtra("brand", jobTags.toString());
                BrandActivity.this.setResult(8, intent);
    ...
    private class StickerSpan extends ImageSpan {
        ...
        public void draw(Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
            ...
            canvas.save();
            int transY = (int) (bottom - b.getBounds().bottom - ScreenUtil.dp2px(BrandActivity.this, 0));// 减去行间距
