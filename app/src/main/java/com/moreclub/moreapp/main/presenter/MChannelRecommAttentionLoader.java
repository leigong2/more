...
public class MChannelRecommAttentionLoader extends
        BasePresenter<IMChannelRecommAttentionLoader.LoadMChannelRecommBinder>
        implements IMChannelRecommAttentionLoader {
    @Override
