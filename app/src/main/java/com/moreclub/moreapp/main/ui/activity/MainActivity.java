...
import com.moreclub.moreapp.main.ui.view.CircleIndicator;
import com.moreclub.moreapp.main.ui.view.CycleGalleryViewPager;
...
public class MainActivity extends BaseListActivity implements IMainDataLoader.LoadMainDataBinder {
    ...
    @BindView(R.id.main_more_logo)
    ImageView mainMoreLogoIv;
    ...
    private View.OnClickListener mSpaceClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            //Todo 进入全城签到广场
            AppUtils.pushLeftActivity(MainActivity.this, SignInterHotalActivity.class);
        }
    };
    ...
    private void backClick() {
        ...
        if (isFromAdert) {
            AppUtils.pushLeftActivity(MainActivity.this, SuperMainActivity.class);
            finish();
        } else {
    ...
    protected void onInitialization(Bundle bundle) {
        ...
        headlineCounts = new ArrayList<>();
        merchantCounts = new ArrayList<>();
        activities = new ArrayList<>();
        peopleViewParent = new ArrayList<>();
        channelList = new ArrayList<>();
        signInterUserList = new ArrayList<>();
        bannerList = new ArrayList<>();
        if (MoreUser.getInstance().getUid() != null && MoreUser.getInstance().getUid() != 0) {
            MiPushClient.setAlias(this, "" + MoreUser.getInstance().getUid(), null);
        }
        ...
        setupViews();
        activityTitle.setText("首页");
        int defaultCityId = 2;
        ((MainDataLoader) mPresenter).onLoadBanner(cityId, "spage", 0);
        ((MainDataLoader) mPresenter).onLoadBizArea(cityCode);
        ((MainDataLoader) mPresenter).onLoadFeatureTag();
        ((MainDataLoader) mPresenter).onLoadHeadlineCount();
        ((MainDataLoader) mPresenter).onLoadMerchantCount(cityCode, cityId);
        ((MainDataLoader) mPresenter).onLoadLiveList(cityCode, 0, 10, 0, MoreUser.getInstance().getUid());
        ((MainDataLoader) mPresenter).onLoadMainChannelList(MoreUser.getInstance().getUid(), cityId, page, PAGE_SIZE);
        ((MainDataLoader) mPresenter).onLoadSignInterUser(cityCode);
    }
    ...
    private void setupViews() {
        ...
        header = LayoutInflater.from(this).inflate(R.layout.main_header,
                (ViewGroup) findViewById(android.R.id.content), false);
        xRecyclerView.setLayoutManager(layoutManager);
        xRecyclerView.setPullRefreshEnabled(false);
        xRecyclerView.addHeaderView(header);
        navBack.setOnClickListener(backListener);
...
//                }
        ...
        adapter = new MainMultiTypeAdapter(this, areas, dicts, merchants, packages, headlineCounts, merchantCounts, activities, channelList);
        ...
        bannelHeadHeight = ScreenUtil.dp2px(this, 295);
        ...
        mchannelImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtils.pushLeftActivity(MainActivity.this, MChannelListActivity.class);
            }
        });
        ...
        mlivepartyImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppUtils.pushLeftActivity(MainActivity.this, ActivitiesActivity.class);
            }
        });

        int sw = ScreenUtil.getScreenWidth(MainActivity.this);
        int ssw = (int) (sw * 0.8);
        bannelH = (int) (((float) ScreenUtil.dp2px(MainActivity.this, 169) / ScreenUtil.dp2px(MainActivity.this, 288)) * ssw);
        if (bannelH == 0) {
            bannelH = ScreenUtil.dp2px(MainActivity.this, 170);
        } else {
            int scaleH = bannelH - ScreenUtil.dp2px(MainActivity.this, 170);
        ...
        /**zune:测试资讯的测试入口**/
        mainMoreLogoIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                AppUtils.pushDownActivity(MainActivity.this, MessageCenterFragment.class);
                /**zune:头条入口**/
//                AppUtils.pushLeftActivity(MainActivity.this,HeadlineActivity.class);
                /**zune:新店入口**/
//                AppUtils.pushLeftActivity(MainActivity.this,NewStoreActivity.class);
                /**zune:活动列表入口**/
//                AppUtils.pushLeftActivity(MainActivity.this,ActivitiesActivity.class);
                /**zune:星空图入口**/
//                AppUtils.pushLeftActivity(MainActivity.this,HomeStarActivity.class);
            }
        });
        ...
        switch (type) {
            ...
            case 0:
                ActivityOptionsCompat compat1 = ActivityOptionsCompat.makeCustomAnimation(
                        MainActivity.this, R.anim.slide_right_in, R.anim.slide_right_out);
                Intent intent1 = new Intent(MainActivity.this, MChannelDetailsAcitivy.class);
                Long relationId = item.getRelationId();
                int send = Integer.parseInt(relationId + "");
                intent1.putExtra("sid", send);
                ActivityCompat.startActivity(MainActivity.this, intent1, compat1.toBundle());
                break;
            case 1:
                if (item != null) {
                    ...
                    ActivityOptionsCompat compat2 = ActivityOptionsCompat.makeCustomAnimation(
                            MainActivity.this, R.anim.slide_right_in, R.anim.slide_right_out);
                    ActivityCompat.startActivity(MainActivity.this, intent2, compat2.toBundle());
                }
                break;
            case 2:
                if (item != null) {
                    if (item.getRelationId() != null && !item.getRelationId().equals(0L)) {
                        ...
                        Intent intent2 = new Intent(MainActivity.this, PlayMoreActivity.class);
            ...
            case 4:
                ActivityOptionsCompat compat = ActivityOptionsCompat.makeCustomAnimation(
                        MainActivity.this, R.anim.slide_right_in, R.anim.slide_right_out);
                Intent intent = new Intent(MainActivity.this, MerchantDetailsViewActivity.class);
    ...
    private void setupChatPeople(ArrayList<SignInterUser> userList) {
        ...
        for (int i = 0; i < totalArray.size(); i++) {
            ...
            View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.channel_user_six_item,
                    null, false);
            ...
            for (int j = 0; j < dataItem.size(); j++) {
                ...
                if (TextUtils.isEmpty(signItem.getUserThumb()) && signItem.getUid() > 0) {
                    ...
                    Glide.with(MainActivity.this)
                            ...
                            .dontAnimate()
                            .transform(new GlideCircleTransform(MainActivity.this, 2, 0xF0F0F0))
        ...
        MainHeaderPeopleAdapter peopleAdapter = new MainHeaderPeopleAdapter(this, peopleViewParent);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        ((MainDataLoader) mPresenter).onLoadBanner(defaultCityId, "spage", 0);
        ((MainDataLoader) mPresenter).onLoadBizArea(cityCode);
        ((MainDataLoader) mPresenter).onLoadPkgs(cityCode, uid, 0, 10);
        ((MainDataLoader) mPresenter).onLoadMerchants(cityCode, 0, 5);
        ((MainDataLoader) mPresenter).onLoadHeadlineCount();
        ((MainDataLoader) mPresenter).onLoadMerchantCount(cityCode, cityId);
        ((MainDataLoader) mPresenter).onLoadLiveList(cityCode, 0, 10, 1, uid);
    }
    ...
    public void onBannerResponse(RespDto responce) {
        ...
        if (bannerIsEmpty) {
            ...
            bannelHeadHeight = ScreenUtil.dp2px(this, 105);
